...
module.exports = {
  ...
  // CloudWatch
  getCloudWatchId(functionName) {
    return `${functionName}CloudWatch`;
  },
  getCloudWatchLogicalId(functionName, cloudWatchIndex) {
  ...
  getLambdaCloudWatchPermissionLogicalId(functionName, cloudWatchIndex) {
