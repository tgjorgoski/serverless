...
module.exports = {
  ...
  // CloudWatch Events
  getEventsRuleId(functionName) {
    return `${functionName}EventsRule`;
  },
  getEventsRuleLogicalId(functionName, cloudWatchIndex) {
    return `${this.getNormalizedFunctionName(functionName)}EventsRuleCloudWatch${cloudWatchIndex}`;
  },
  ...
  getLambdaEventsRulePermissionLogicalId(functionName, cloudWatchIndex) {
    return `${this.getNormalizedFunctionName(functionName)}LambdaPermissionEventsRuleCloudWatch${
      cloudWatchIndex}`;
  },
